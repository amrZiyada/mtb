...
function validAddress(value:unknown){return value==null||value===''||(typeof value==='string'&&value.trim().length<=500)}
function validBookingFields(body:any){return validName(body.patient_name)&&validPhone(body.phone)&&validAge(body.age)&&validGender(body.gender)&&validPreferredAt(body.preferred_at)&&validTests(body.tests)&&validAddress(body.address)}
