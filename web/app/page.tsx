      ...
      <header className="bg-slate-900 text-white">
        <div className="mx-auto max-w-6xl px-4 py-7">
          ...
          <p className="mt-1 text-slate-300">
            Choose your tests and reserve a convenient time.
          </p>
        </div>
      </header>

      <div className="mx-auto grid max-w-6xl gap-6 px-4 py-6 lg:grid-cols-[1fr_330px]">
                ...
                onKeyDown={e=>{
                  if(
                    ...
                    if(first){
                      setCart(c=>({
                        ...c,
                        [first.test_no]:(c[first.test_no]||0)+1
                      }))
                  ...
                  <div className="flex items-start justify-between gap-4">
                    ...
                    <div className="min-w-0">
                      ...
                      <div className="mt-2 text-xs font-medium text-slate-600">
                        TAT: {t.duration} {t.duration===1?'hour':'hours'}
                      </div>
        ...
        <aside className="h-fit rounded-2xl border bg-white p-5 shadow-sm lg:sticky lg:top-4">
          ...
          <div className="mt-4 space-y-2">
            ...
            {selected.map(t=>(
              ...
              >
                <span>
                  {t.analysis_name} × {cart[t.test_no]}
                </span>

                <span>
                  {t.patient_price*cart[t.test_no]}
                </span>
              </div>
            ))}
          ...
          <div className="my-4 flex justify-between border-t pt-4 font-bold">
          ...
          <button
            ...
            className="w-full rounded-xl bg-slate-900 px-4 py-3 font-semibold text-white disabled:opacity-40"
          >
            Reserve
          </button>
      ...
      {done&&(
        <div className="fixed inset-0 z-50 grid place-items-center bg-black/50 p-4">
          ...
          <div className="w-full max-w-md rounded-2xl bg-white p-7 text-center">
            ...
            <div className="my-3 rounded-xl bg-slate-100 p-4 text-2xl font-bold tracking-widest">
              {done.reference}
            </div>

            <p className="text-sm text-slate-500">
              Total: {done.total} EGP
            </p>
