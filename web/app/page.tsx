    ...
    {selected.length>0 ? <>
      <div className="mt-3 max-h-52 space-y-2 overflow-auto">
        {selected.map(t=><div className="flex items-center justify-between gap-3 text-sm" key={t.test_no}>
          <div className="min-w-0 flex-1"><div className="truncate font-medium">{t.analysis_name}</div><div className="text-xs text-slate-500">{cart[t.test_no]} × {t.patient_price} EGP</div></div>
